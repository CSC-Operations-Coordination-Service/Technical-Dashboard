...
Welcome to `maas-out` contributor's guide.
...
If you experience bugs or general issues with `maas-out`, please have a look
...
You can help improve `maas-out` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`maas-out` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `maas-out`'s files. While this mechanism can
...
```
conda create -n maas-out python=3 six virtualenv pytest pytest-cov
conda activate maas-out
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/maas-out.git
   cd maas-out
   ```
...
5. Install [pre-commit]:
   ...
   `maas-out` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/maas-out
[issue tracker]: https://github.com/<USERNAME>/maas-out/issues
